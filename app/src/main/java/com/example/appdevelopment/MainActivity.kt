...
//    private var isExpanded = false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        collapsePanels.add(CollapsePanel(2, "家人们谁懂", "该梗出自抖音上的不露脸特效西瓜条，不露脸的特效拍摄的内容可以是五花八门的", "20", "June 7"))
        collapsePanels.add(CollapsePanel(3, "鸡你太美","鸡你太美，是一句网络流行语，为2016年11月29日SWIN-S发布的歌曲《只因你太美》的空耳。", "17", "June 8"))
        collapsePanels.add(CollapsePanel(4, "泰裤辣","泰裤辣”是一个近期流行的网络梗，源自于小鬼王琳凯在演唱会上说的一句话", "45", "June 5"))
