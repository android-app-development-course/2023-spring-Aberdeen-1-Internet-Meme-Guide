...
//    private var isExpanded = false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        collapsePanels.add(CollapsePanel(3, "鸡你太美，是一句网络流行语，为2016年11月29日SWIN-S发布的歌曲《只因你太美》的空耳。"))
        collapsePanels.add(CollapsePanel(4, "泰裤辣”是一个近期流行的网络梗，源自于小鬼王琳凯在演唱会上说的一句话"))
        collapsePanels.add(CollapsePanel(5, "现如今，很多人开始用拼音首字母来代替自己想要表达的意思，这是一种在零零后群体中比较流行的字母缩写流，例如“啊我死了”被说成“awsl”"))
